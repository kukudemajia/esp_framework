...
/* Generated by nanopb-0.3.9.4 at Fri Mar 03 18:04:57 2023. */
...
const pb_field_t MqttConfigMessage_fields[11] = {
    ...
    PB_FIELD(  7, STRING  , SINGULAR, STATIC  , OTHER, MqttConfigMessage, force_ota_topic, topic, 0),
    PB_FIELD(  8, BOOL    , SINGULAR, STATIC  , OTHER, MqttConfigMessage, discovery, force_ota_topic, 0),
    PB_FIELD(  9, STRING  , SINGULAR, STATIC  , OTHER, MqttConfigMessage, discovery_prefix, discovery, 0),
    PB_FIELD( 10, UINT32  , SINGULAR, STATIC  , OTHER, MqttConfigMessage, interval, discovery_prefix, 0),
    PB_LAST_FIELD
};
